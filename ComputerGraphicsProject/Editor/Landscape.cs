...
namespace Editor
{
    ...
    class Landscape
    {
        ...
        public void SaveHeightmap(string FileName, out Bitmap Result)
        {
            ...
            img.Save(@"C:\Users\User\Desktop\ComputerGraphicsProject\Data\manual_land\my.bmp", System.Drawing.Imaging.ImageFormat.Bmp);
        ...
        public void SaveLightmap(string FileName, out Bitmap Result)
        {
            ...
            img.Save(@"C:\Users\User\Desktop\ComputerGraphicsProject\Data\manual_land\my1.bmp", System.Drawing.Imaging.ImageFormat.Bmp);
            img.UnlockBits(bmpData);
        ...
        public void SaveColormap(string FileName, out Bitmap Result)
        {
            ...
            img.Save(@"C:\Users\User\Desktop\ComputerGraphicsProject\Data\manual_land\my2.bmp", System.Drawing.Imaging.ImageFormat.Bmp);
            img.UnlockBits(bmpData);
